...
mkdir -p $RES_DIR
# Rename YOUR_MODEL with the appropriate path of your model
...
# add your path to source, in this case your regular sentences
SRC=/PATH_TO_SOURCE
# add your path to target, in this case your simplified sentences
TGT=/PATH_TO_TARGET
cd $OPENNMT_PATH
